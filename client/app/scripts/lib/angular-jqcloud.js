/*
  Angular jQCloud
  For jQCloud 2 (httpsgithub.commistic100jQCloud)
  Copyright 2014 Damien Mistic Sorel (httpwww.strangeplanet.fr)
  Licensed under MIT (httpopensource.orglicensesMIT)
*/
